...
-- CreateEnum
CREATE TYPE "public"."ToyType" AS ENUM ('BOYS', 'GIRLS');
...
-- AddForeignKey
ALTER TABLE "public"."Lend" ADD CONSTRAINT "Lend_lenderId_fkey" FOREIGN KEY ("lenderId") REFERENCES "public"."User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Lend" ADD CONSTRAINT "Lend_borrowerId_fkey" FOREIGN KEY ("borrowerId") REFERENCES "public"."User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Lend" ADD CONSTRAINT "Lend_toyId_fkey" FOREIGN KEY ("toyId") REFERENCES "public"."Toy"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
