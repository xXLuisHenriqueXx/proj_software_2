...
export const highlightTypeEnum = z.string();
...
export const highlightCreateSchema = z.object({
  ...
  description: z.string().max(300, "A descrição não pode ter mais de 300 caracteres.").optional(),
  type: highlightTypeEnum,
  picture: z.string().regex(/^data:image\/[a-zA-Z]+;base64,/, "Formato de imagem Base64 inválido.").optional()
});
